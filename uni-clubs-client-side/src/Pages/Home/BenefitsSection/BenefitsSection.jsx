    ...
    >
      <div className="container mx-auto px-4 ">
        ...
        <div className="lg:flex lg:gap-12 mt-12 items-center">
          ...
          <div
            className="lg:w-full mt-10 lg:mt-0  p-6 shadow-md shadow-gray-300 bg-gradient-to-br from-blue-200/20 via-transparent to-blue-200/10 rounded-2xl relative">
            {/* vertical line */}
