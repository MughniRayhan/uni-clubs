...
export default function CallToAction() {
  ...
  return (
    <section className="relative overflow-hidden bg-gray-900 text-white py-20 mt-10">
      ...
      <motion.div
        className="absolute bottom-10 right-10 w-56 h-56 bg-blue-500/30 rounded-full blur-3xl"
      ...
      <div className="relative max-w-5xl mx-auto px-6 text-center space-y-8">
        ...
        >
          ...
          <span className="bg-gradient-to-r  from-blue-400 via-green-200 to-blue-400 bg-clip-text text-transparent">University Clubs?</span>
        </motion.h2>
